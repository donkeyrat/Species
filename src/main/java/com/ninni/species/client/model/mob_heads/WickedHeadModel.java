...
@OnlyIn(Dist.CLIENT)
public class WickedHeadModel extends SkullModelBase {
    ...
    @Override
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int i, int i1, int v) {
        this.root.render(poseStack, vertexConsumer, i, i1, v);
    }
}
