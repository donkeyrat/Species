...
public class HopelightBlockEntityRenderer implements BlockEntityRenderer<HopelightBlockEntity> {
    ...
    public void render(HopelightBlockEntity blockEntity, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
        ...
        if (blockEntity.getBlockState().getValue(BlockStateProperties.HANGING)) {
            ...
            if (!blockEntity.getBlockState().getValue(CONNECTED_Y)) {
                builder.addVertex(poseStack.last().pose(), right, right, left)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(1F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), left, right, left)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(0F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), left, right, right)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(0.5F, 0.5F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), right, right, right)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(1, 1)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
            ...
            if (!blockEntity.getBlockState().getValue(CONNECTED_Y)) {
                builder.addVertex(poseStack.last().pose(), right, left, left)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(1F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), left, left, left)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(0F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), left, left, right)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(0.5F, 0.5F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), right, left, right)
                        .setColor(-r, -g, -b, 1F)
                        .setUv(1, 1)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
            ...
            if (!blockEntity.getBlockState().getValue(NORTH)) {
                //FRONT
                builder.addVertex(poseStack.last().pose(), vertices2[3].x, vertices2[3].y, left)
                        .setColor(-r,-g,-b,1F)
                        .setUv(1F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), vertices2[2].x, vertices2[2].y, left)
                        .setColor(-r,-g,-b,1F)
                        .setUv(0F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), vertices2[4].x, vertices2[4].y, left)
                        .setColor(r,g,b,0)
                        .setUv(0.5F, 0.5F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), vertices2[5].x, vertices2[5].y, left)
                        .setColor(r,g,b,0)
                        .setUv(1, 1)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
            ...
            if (!blockEntity.getBlockState().getValue(SOUTH)) {
                //BACK
                builder.addVertex(poseStack.last().pose(), vertices2[3].x, vertices2[3].y, right)
                        .setColor(-r,-g,-b,1F)
                        .setUv(1F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), vertices2[2].x, vertices2[2].y, right)
                        .setColor(-r,-g,-b,1F)
                        .setUv(0F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), vertices2[4].x, vertices2[4].y, right)
                        .setColor(r,g,b,0)
                        .setUv(0.5F, 0.5F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), vertices2[5].x, vertices2[5].y, right)
                        .setColor(r,g,b,0)
                        .setUv(1, 1)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
            ...
            if (!blockEntity.getBlockState().getValue(WEST)) {
                //LEFT
                builder.addVertex(poseStack.last().pose(), left, vertices2[3].y, left)
                        .setColor(-r,-g,-b,1F)
                        .setUv(1F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), left, vertices2[2].y, right)
                        .setColor(-r,-g,-b,1F)
                        .setUv(0F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), left, vertices2[4].y, right)
                        .setColor(r,g,b,0)
                        .setUv(0.5F, 0.5F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), left, vertices2[5].y, left)
                        .setColor(r,g,b,0)
                        .setUv(1, 1)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
            ...
            if (!blockEntity.getBlockState().getValue(EAST)) {
                //RIGHT
                builder.addVertex(poseStack.last().pose(), right, vertices2[3].y, left)
                        .setColor(-r,-g,-b,1F)
                        .setUv(1F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), right, vertices2[2].y, right)
                        .setColor(-r,-g,-b,1F)
                        .setUv(0F, 0F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), right, vertices2[4].y, right)
                        .setColor(r,g,b,0)
                        .setUv(0.5F, 0.5F)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
                        .setNormal(poseStack.last(), 0.0F, 1.0F, 0.0F);
                builder.addVertex(poseStack.last().pose(), right, vertices2[5].y, left)
                        .setColor(r,g,b,0)
                        .setUv(1, 1)
                        .setOverlay(OverlayTexture.NO_OVERLAY)
                        .setLight(15728880)
    ...
    public ResourceLocation getTextureLocation() {
        return ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/block/spectre_glow_base.png");
    }

    @Override
    public net.minecraft.world.phys.AABB getRenderBoundingBox(HopelightBlockEntity blockEntity) {
        BlockPos pos = blockEntity.getBlockPos();
        if (blockEntity.getLevel().getBlockState(pos).getBlock() instanceof HopelightBlock) {
            if (blockEntity.getLevel().getBlockState(pos).getValue(HopelightBlock.HANGING)) return new AABB(pos.getX(), pos.getY() - 4, pos.getZ(), pos.getX() + 1.0, pos.getY() + 1, pos.getZ() + 1.0);
            else return new AABB(pos.getX(), pos.getY() + 4, pos.getZ(), pos.getX() + 1.0, pos.getY() - 1, pos.getZ() + 1.0);
        } else return BlockEntityRenderer.super.getRenderBoundingBox(blockEntity);
    }
}