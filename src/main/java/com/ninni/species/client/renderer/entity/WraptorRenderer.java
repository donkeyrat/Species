...
public class WraptorRenderer<T extends LivingEntity> extends MobRenderer<Wraptor, WraptorModel<Wraptor>> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/wraptor/wraptor.png");
    public static final ResourceLocation TEXTURE_GOTH = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/wraptor/wraptor_goth.png");
    public static final ResourceLocation TEXTURE_TRANS = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/wraptor/wraptor_trans.png");
