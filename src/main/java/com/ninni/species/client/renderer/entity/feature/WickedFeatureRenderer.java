...
public class WickedFeatureRenderer<T extends Wicked, M extends WickedModel<T>> extends RenderLayer<T, M> {
    private static final RenderType WICKED_EYES = RenderType.entityTranslucentEmissive(ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/wicked/wicked_eyes.png"));
