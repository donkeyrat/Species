...
public class StackatickRenderer<T extends LivingEntity> extends MobRenderer<Stackatick, StackatickModel<Stackatick>> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/stackatick/stackatick.png");
    public static final ResourceLocation SITTING_TEXTURE = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/stackatick/stackatick_sleeping.png");
