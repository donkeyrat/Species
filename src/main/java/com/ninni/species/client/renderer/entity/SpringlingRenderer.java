...
public class SpringlingRenderer<T extends LivingEntity> extends MobRenderer<Springling, SpringlingModel<Springling>> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/springling/springling.png");
    public static final ResourceLocation TEXTURE_NECK = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/springling/springling_neck.png");
    public static final ResourceLocation TEXTURE_PISTON = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/springling/springling_piston.png");
    public static final ResourceLocation TEXTURE_PISTON_NECK = ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/entity/springling/springling_neck_piston.png");
